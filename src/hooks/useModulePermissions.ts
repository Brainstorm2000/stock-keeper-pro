...
export type AppModule = 'pos' | 'sales' | 'purchases' | 'expenses' | 'production' | 'reports' | 'tax' | 'staff' | 'attendance' | 'tasks' | 'debts' | 'returns' | 'products' | 'dashboard' | 'dashboard_financials' | 'assets';
...
export const ALL_MODULES: AppModule[] = ['pos', 'sales', 'purchases', 'expenses', 'production', 'reports', 'tax', 'staff', 'attendance', 'tasks', 'debts', 'returns', 'products', 'dashboard', 'dashboard_financials', 'assets'];
